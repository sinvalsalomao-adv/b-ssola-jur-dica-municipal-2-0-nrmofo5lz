...
/**
 * Subcomponente isolado para a visão global do Superadmin quando nenhum contexto
 * municipal estiver selecionado. O hook useSuperadmin fica contido aqui para garantir
 * que administradores municipais e usuários comuns nunca dependam dele.
 */
function SuperadminGlobalDashboard() {
...
export default function Dashboard() {
  ...
  // SUPERADMIN: Se não selecionou prefeitura, exibir visão global autorizada isolada
  if (isSuperadmin && !hasTenantContext) {
    return <SuperadminGlobalDashboard />
  }
