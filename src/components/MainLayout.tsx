              ...
              <div className="flex items-center gap-2.5 pl-1">
                <Avatar className="w-9 h-9 border border-gray-200">
                  <AvatarImage
                    ...
                    alt="Usuário"
                  />
                  <AvatarFallback className="bg-[#1c2a3e] text-white">AD</AvatarFallback>
                </Avatar>
                <div className="hidden sm:block text-left">
                  <p className="text-xs font-semibold text-[#1c2a3e]">Dr. Silval Salomão</p>
                  <p className="text-[10px] text-gray-500">Procurador Jurídico</p>
                </div>
              </div>
            </div>
          </header>
